...
public interface MarkMapper {
	...
	@Insert("insert into MarkResult values(#{sub_num}, #{test_num}, #{user_id}, #{sub_code}, #{mark_result}, #{mark_score}, default)")
	...
	@Select("SELECT MR.sub_num, MR.test_num, MR.user_id, MR.sub_code, MR.mark_result, MR.mark_score, TB.test_description\r\n"
			+ "FROM MarkResult MR\r\n"
